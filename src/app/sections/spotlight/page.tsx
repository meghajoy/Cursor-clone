...
//   return (
//     <div className="rounded-xl px-4 bg-[url('/img/gradient.avif')] mx-auto bg-cover bg-center w-full max-w-[1310px] h-full h-max-[632px]">
...
//           <img src="/img/watch-demo.avif" alt="demo img" width={3860} height={3860} style={{
//             width: "3860px",
//             height: "220px",
