...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 mx-auto py-7 w-[1296px] ">
        <div className="flex justify-between items-center px-[7px] py-[6px] bg-stone-950 rounded-xl">
        ...
        <div className="flex gap-4 items-center">
            <div className="flex items-center border-[0.5px] border-solid border-neutral-400 rounded-lg px-4 py-3.5 hover:border-neutral-200 hover:border-neutral-200">
                <a href="#" className="flex gap-4 font-mono font-semibold uppercase text-neutral-300">Sign Up</a>
            </div>
            <div className="flex gap-2 items-center bg-stone-100 rounded-lg px-4 py-3.5">
                <Image src="/img/download.svg" alt="Download icon" width={14} height={16}/>
